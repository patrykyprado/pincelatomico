...
$sql_linha_digital = mysql_query("INSERT INTO titulos_codigos (id_controle,id_titulo, codigo_barras, nosso_numero, conta, data_hora) VALUES (NULL,'".$dadosboleto["numero_documento"]."', '".str_replace(array(" ","."),array("",""),$dadosboleto["linha_digitavel"])."', '".$tmp_bd."','".$dadosboleto["conta"]."','$datahoraatual')");
?>
</span></span></td>

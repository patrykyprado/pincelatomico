...
$tmp_bd = $dadosboleto["nosso_numero"];
$tmp_bd = substr($tmp_bd,0,strlen($tmp_bd)-1).'-'.substr($tmp_bd,strlen($tmp_bd)-1,1);
$sql_linha_digital = mysql_query("INSERT INTO titulos_codigos (id_controle,id_titulo, codigo_barras, nosso_numero, conta, data_hora) VALUES (NULL,'".$dadosboleto["numero_documento"]."', '".str_replace(array(" ","."),array("",""),$dadosboleto["linha_digitavel"])."', '".$tmp_bd."','".$dadosboleto["codigo_cliente"]."','$datahoraatual')");
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=126 height=12> 
  ...
  <?php echo $dadosboleto["ponto_venda"]." <img src='imagens/b.png' width=10 height=1> ".$dadosboleto["codigo_cliente"]?>
  </span></td>

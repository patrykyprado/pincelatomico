...
WHERE oco.n_ocorrencia = 1 AND oco.matricula = $codigo AND oco.id_turma = $id_turma LIMIT 1");
		...
		while($dados_ativ = mysql_fetch_array($pesquisar)){
			...
			echo "<td align=\"center\"><input type=\"text\" name=\"nota\" id=\"nota\" matricula=\"$codigo\" ref_ativ=\"$ref_id\" turma_disc=\"$turma_disc\" grupoativ=\"$grupo_ativ\" maxnota=\"$valor_ativ\" value=\"$nota_aluno\" style=\"width:50px\" /> <b> | <font color=\"red\">$valor_ativ</font></b>

                      ...
                      <section class="panel">
                          <div class="panel-body progress-panel">
                              <div class="task-progress">
                                  <h1>Matrículas Curso Técnico</h1>
                              </div>
                          </div>
                          <?php
...
$get_grupo = '2015/01';
$get_modulo = 1;
$get_modelo = 6;//$_GET['modelo'];
$get_nivel = "Curso Técnico";
...
if(mysql_num_rows($sql_grafico)>=1){
	echo "<table class=\"\" width=\"auto\" align=\"center\" border=\"1\">
<tr> 

                  ...
                  <div class="col-md-12">
                      <section class="panel">
                        <header class="panel-heading">
                              <b>Relat&oacute;rio: Rematr&iacute;cula / Turma</b>
                          </header>
...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
        ...
        echo "
	<tr>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><b><center>$codigo</b></center></a></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\">$nivel</td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$curso</center></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$modulo</center></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$turno</center></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$grupo</center></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$unidade</center></td>
		<td><a rel=\"shadowbox\" href=\"rematricula_turma.php?id_turma=$id_turma\"><center>$polo</center></td>
		\n";

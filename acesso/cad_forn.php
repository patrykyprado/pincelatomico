                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b>Cadastro de Cliente / Fornecedor</b>
                          </header>
                          <div class="panel-body">
                <form action="cad_forn.php" method="POST" onKeyPress="return arrumaEnter(this, event)">
...
<tr>
	<td align="right"><b>Nome Fantasia:</b></td>
                               <td><input id="fantasia" style="width:400px" name="fantasia" type="text" placeholder="Nome Fantasia (se houver)" onKeyPress="return arrumaEnter(this, event)"/></td>
</tr>
<tr>
...
</tr><input id="tipo" name="tipo" type="hidden" placeholder="TIPO" required onKeyPress="return arrumaEnter(this, event)" value="2"/><tr>

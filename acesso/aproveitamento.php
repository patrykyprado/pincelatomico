...
<form action="buscar_aproveitamento.php" method="get">
<table align="center" width="50%">
	<tr>
    <td><b>Nome:</b></td>
     <td colspan="3"><input type="text" style="width:400px" name="nome"></td>
    </tr>
    <tr>
    <td><b>Status:</b></td>
	...
	<tr>
    <td colspan="4" bgcolor="#E1E1E1" align="center"><b>Per&iacute;odo de Solicita&ccedil;&atilde;o</b></td>
    </tr>
    <tr>
    ...
    <tr>
    <td colspan="4" bgcolor="#E1E1E1" align="center"><input type="submit" value="Pesquisar"></td>
    </tr>
</table>
</form>

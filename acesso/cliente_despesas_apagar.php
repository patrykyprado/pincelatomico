                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b>T&iacute;tulos a Pagar - Cliente / Fornecedor</b>
                          </header>
                          <div class="panel-body">
<form id="form1" name="form1" method="get" action="cliente_despesas_apagar.php">
Cliente / Fornecedor: <input type="text" name="nome" value="<?php echo $busca;?>" id="nome" /> 
...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
        ...
        echo "
	<tr>
		<td><a href=\"despesas_fornecedor.php?codigo=$codigo&nome=$nome\">$nome</a></td>
		<td>&nbsp;$tel / $tel2</td>
		\n";

                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b>Pesquisa de Turmas</b>
                          </header>
                          <div class="panel-body">
<form id="form1" name="form1" method="get" action="filtro_boleto_turma.php">
<table class="full_table_cad" width="60%" align="center" cellpadding="3">
<tr>
<td align="right"><B>N&iacute;vel:</B></td>
<td>
<select name="nivel" class="textBox" id="nivel" style="width:200px;" onKeyPress="return arrumaEnter(this, event)">
...
<td><select name="curso" class="textBox" style="width:200px;" id="curso" onKeyPress="return arrumaEnter(this, event)">
...
<td ><select name="modulo" class="textBox" style="width:200px;" id="modulo" onKeyPress="return arrumaEnter(this, event)">
...
<td ><select name="turno" class="textBox" style="width:200px;" id="turno" onKeyPress="return arrumaEnter(this, event)">
...
<td><select name="unidade" class="textBox" style="width:200px;" id="unidade" onKeyPress="return arrumaEnter(this, event)">
...
<td ><select name="polo" class="textBox" style="width:200px;" id="polo" onKeyPress="return arrumaEnter(this, event)">
...
<td><select name="grupo" class="textBox" style="width:200px;" id="grupo" onKeyPress="return arrumaEnter(this, event)">
...
<tr>
	<td align="right"><b>Ano Referência:</b></td>
    <td><select name="ano_ref" style="width:200px;">

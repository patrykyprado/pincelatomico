                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b>Resumo de Envio (SMS): Rematr&iacute;cula</b>
                          </header>
...
$msg_list  = "5527998450730;Patryky Prado Feliz 2015! Faça sua rematrícula no CEDTEC e garanta seu futuro. O prazo com garantia de vaga é até 09/01.;021;CEDTEC;19/11/2014 12:52:00"."\n";
...
while($dados_sms = mysql_fetch_array($sql_sms)){
	...
	if($celular_aluno == "Número Inválido"){
		...
		$msg_list .= $celular_aluno.";$nome_aluno Feliz 2015! Faça sua rematrícula no CEDTEC e garanta seu futuro.;$contador_sms;CEDTEC;07/01/2015 12:00:00"."\n";
		$contador_sms +=1;

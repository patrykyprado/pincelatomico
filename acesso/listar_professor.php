...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
        ...
        echo "
	<tr>
		<td align='center'>&nbsp;<a href=\"editar_professor.php?id=$codigo\" rel=\"shadowbox\"><font size=\"+1\"><div class=\"fa fa-edit tooltips\" data-placement=\"right\" data-original-title=\"Editar Professor\"></div></font></a></td>
		<td>&nbsp;$codigo</td>
		<td>&nbsp;$nome</td>
		\n";

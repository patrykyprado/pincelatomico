...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql_turmas)) {
        ...
        echo "
	<tr>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><b><center>$codigo</b></center></a></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\">$nivel</td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$curso</center></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$modulo</center></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$turno</center></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$grupo</center></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$unidade</center></td>
		<td><a href=\"listar_disciplinas_turma.php?grupo=$grupo&turma=$codigo&turno=$turno&polo=$polo&id_turma=$id_turma\"><center>$polo</center></td>
		</tr>
		\n";

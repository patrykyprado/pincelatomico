...
<form id="form1" name="form1" method="get" action="gerar_ccusto.php" target="_blank">
...
?>
  ...
  <tr>
    <td>Tipo:</td>
    <td><input type="radio" name="tipo_rel" value="1" checked> Gerencial<br />
<input type="radio" name="tipo_rel" value="2"> Consolidado</td>
    <td></td>
    </tr>
  <tr>
    <td>Ebitda:</td>
    <td colspan="2"><input type="radio" name="ebitda" value="geral" checked="checked" />
      Geral<br />
  <input type="radio" name="ebitda" value="S" />
      Sim<br />
  ...
  <tr>
    <td>Layout:</td>
    <td><input type="radio" name="layout" value="1" checked> Anal&iacute;tico<br />
<input type="radio" name="layout" value="2"> Sint&eacute;tico</td>
    <td></td>
    </tr>

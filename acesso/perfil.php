...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if($user_senha != $_POST["senha_anterior"]){
		echo "<script language=\"javascript\">
		alert('Senha atual errada. Digite a correta para realizar as alterações');
		history.back();
		</script>";	
	}
                  ...
                  <div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b>Edi&ccedil;&atilde;o de Perfil</b>
                          </header>
                            ...
                            <form name="form_turma" method="post" action="confirmar_dados_acesso.php" class="form-horizontal" id="default">
                              <fieldset title="Confirmação de dados" class="step" id="step1">
                                ...
                                <input required class="form-control input-sm m-bot15" name="email" type="text" value="<?php echo $user_email;?>"/>
                                      ...
                                      <div class="form-group">
                                          <label class="col-lg-2 control-label"><b>Senha Atual</b></label>
                                          <div class="col-lg-10">
                                         <input required class="form-control input-sm m-bot15" name="senha_atual" type="password" value=""/>
                                          </div>
                                       </div>

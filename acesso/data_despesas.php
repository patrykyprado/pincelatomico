...
if ($count == 0) {
    ...
    while ($dados = mysql_fetch_array($sql)) {
		...
		//	$comp_excluir = "";
		//} else {
			$comp_excluir = "<a href=\"javascript:aviso($idtitulo)\"><font size=\"+1\"><div class=\"fa fa-trash-o tooltips\" data-placement=\"right\" data-original-title=\"Excluir Título\"></div></font></a>";
		//}
        echo "
	<tr>
		<td align='center'>
		<a rel=\"shadowbox\" href=\"editar.php?id=$idtitulo\"><font size=\"+1\"><div class=\"fa fa-edit tooltips\" data-placement=\"right\" data-original-title=\"Editar Título\"></div></font></a>
	    $comp_excluir</td>
		<td>&nbsp;$cliente</td>

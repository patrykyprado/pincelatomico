...
$sql_sms = mysql_query("SELECT codigo, nome, celular FROM alunos WHERE codigo IN ($get_codigos)");
$msg_list  = "5527998450730;Olá Patryky Prado Feliz ano novo!!! Início das aulas no CEDTEC 02 de Fevereiro, esperamos por você !!! Dúvidas ligue para sua unidade, cedtec.com.br;$contador_sms;CEDTEC;19/11/2014 12:52:00"."\n";
$contador_sms +=1;
...
while($dados_sms = mysql_fetch_array($sql_sms)){
	...
	if($celular_aluno == "Número Inválido"){
		...
		$msg_list .= $celular_aluno.";Olá $nome_aluno Feliz ano novo!!! Início das aulas no CEDTEC 02 de Fevereiro, esperamos por você !!! Dúvidas ligue para sua unidade, cedtec.com.br;$contador_sms;CEDTEC;07/01/2015 12:00:00"."\n";
		$contador_sms +=1;

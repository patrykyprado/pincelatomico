                  ...
                  <div class="col-md-12">
                      <section class="panel">
                        <header class="panel-heading">
                              <b>Sistema: Executar Query</b>
                          </header>
                          <div class="panel-body">
<form action="executar_query.php" method="post">
<center><textarea name="query" style="width:500px;"></textarea><br><br>
<input type="submit" value="EXECUTAR QUERY"></center>
<?php
...
$sql_query = $_POST["query"]."  $orderby LIMIT $inicio,$maximo";
$sql_relatorio = mysql_query($sql_query);

$sql_query_max = $_POST["query"]." $orderby";
...
<tr>
	<td colspan="<?php echo $total_span;?>"><?php echo $get_query;?></td>
</tr>
<tr>

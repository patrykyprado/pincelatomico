              ...
              <section class="panel">
                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
						...
						$sql_titulos_apagar = mysql_query("SELECT * FROM geral_titulos WHERE tipo_titulo = 1 AND status = 0 AND (data_pagto is null OR data_pagto LIKE '') AND (vencimento BETWEEN ADDDATE(now(), -4) AND ADDDATE(now(), 4)) AND conta_nome LIKE '%$user_unidade%' AND conta LIKE '%$get_ref_conta%' ORDER BY vencimento LIMIT $limit_tit");
						if(mysql_num_rows($sql_titulos_apagar)==0){
							...
							while($dados_tit = mysql_fetch_array($sql_titulos_apagar)){
								...
								/*echo "<tr  class=\"\">
                                	<td class=\"\" align=\"center\"><a rel=\"shadowbox\" href=\"editar.php?id=$id_titulo\">$id_titulo</a></td>
                                    <td class=\"\"  align=\"center\">$descricao_titulo</td>
                                    <td class=\"\"  align=\"center\">$vencimento_titulo</td>
                                    <td class=\"\"  align=\"right\">R$ $valor_titulo</td>
                                    <td class=\"\"  align=\"center\">$conta_titulo</td>
                                </tr>";
								*/
								echo "<tr class=\"\">
                                  <td>$id_titulo</td>

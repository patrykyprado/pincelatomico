          ...
          <section class="wrapper">
              <div class="row">              
                  ...
                  <div class="col-lg-12">
                      ...
                      <b><a data-toggle="modal" id="abrir_modal" href="#aviso">Resumo Acad&ecirc;mico</a></b>
                      <div class="modal fade" id="aviso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                              <h4 class="modal-title"><center>ATEN&Ccedil;&Atilde;O!  ALERTA DE V&Iacute;RUS!</center></h4>
                                          </div>
                                          <div class="modal-body" style="color:#000000">

                                              Est&aacute; circulando na Internet um v&iacute;rus que modifica a linha digit&aacute;vel dos boletos banc&aacute;rios gerados em sites, fazendo com que os pagamentos sejam desviados para a conta do criminoso sem o que o usu&aacute;rio perceba.<br>
<br>
Orientamos aos usu&aacute;rios que redobrem a aten&ccedil;&atilde;o ao gerarem boletos e mantenham o anti-v&iacute;rus atualizado para evitarem preju&iacute;zos. Na d&uacute;vida, gere e imprima os boletos em computadores confi&aacute;veis ou no Setor Financeiro da Escola.<br>
<br><br>
<img src="http://cedtecvirtual.com.br/pincelatomico/dica.png"/>
<b><center>CEDTEC - Centro de Desenvolvimento T&eacute;cnico</center></b>
...
?>
	...
	$sql_etapa_atividades = mysql_query("SELECT * FROM ced_etapas WHERE tipo_etapa = '$user_tipo_etapa'");
	$sql_etapa_nome = mysql_query("SELECT * FROM ced_etapas WHERE tipo_etapa = '$user_tipo_etapa'");
...
$exibir_professor_topo
		...
		while($dados_turma_disc = mysql_fetch_array($sql_turma_disc)){
			...
			$sql_prof = mysql_query("SELECT * FROM acessos_completos WHERE usuario = $cod_professor");
		...
		";	
		//NOTAS POR ETAPA
		$sql_etapa_notas = mysql_query("SELECT * FROM ced_etapas WHERE nivel LIKE '%$user_turma_nivel%'");
...
AND cta.id_etapa = $etapa_id");
	...
	a_detalhes_nota.php?matricula=$user_usuario&td=$turma_disc&grupo=A&etapa=$etapa_id\">$nota_aluno_a</a></td>
		...
		//PEGA AS FALTAS
		$sql_falta = mysql_query("SELECT COUNT(*) as falta_total FROM ced_falta_aluno WHERE matricula = '$user_usuario' AND turma_disc = '$turma_disc' AND status LIKE 'F' AND data IN (SELECT data_aula FROM ced_data_aula WHERE turma_disc = '$turma_disc')");

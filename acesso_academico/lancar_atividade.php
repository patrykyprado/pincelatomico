...
//enviar post 
 if( $_SERVER['REQUEST_METHOD'] == 'POST') {
	$data2 = $_POST["data"];
	if(strstr($data2, '/')==TRUE){
		$data = substr($data2,6,4)."-".substr($data2,3,2)."-".substr($data2,0,2);
	} else {
		$data = $data2;
	}
...
?>
  ...
  <tr>
    ...
    <td><input type="text" placeholder="" value="" maxlength="10" name="data" id="data" data-mask="99/99/9999" class="form-control"></td>
    </tr>
  <tr>

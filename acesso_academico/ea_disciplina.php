...
<a rel=\"shadowbox\" href=\"../acesso/detalhes_participantes.php?acao=1&turma_disc=$turma_disc&coddisc=$cod_disc&anograde=$anograde\" class=\"btn btn-xs btn-warning\"><font size=\"+1\">Participantes</font></a></div>";  
						  }
						  ?>
...
while($dados_ativ1 = mysql_fetch_array($sql_ativ1)){
	...
	<div style=\"float:left; margin-right:30px\"><a style=\"text-decoration: none;\" target=\"$target_link\" href=\"$comp_link$ativ_link?turma_disc=$turma_disc&tipo_ativ=$d_tipo&cod_ativ=$d_cod_ativ&anograde=$anograde&cod_disc=$cod_disc\"><img src=\"../acesso/frames_ead/icones/$ativ_rotulo\" title=\"$ativ_tipo\" alt=\"$ativ_tipo\" height=\"auto\">$editor<br>
...
echo "
<div style=\"float:left; margin-right:30px;\"><a style=\"text-decoration: none;\" target=\"frame_central_ead\" href=\"../acesso/frames_ead/frame_simulado.php?turma_disc=$turma_disc&tipo_ativ=7&cod_ativ=00&anograde=$anograde&cod_disc=$cod_disc\"><img src=\"../acesso/frames_ead/icones/icone_simulado.png\" title=\"Simulado\" alt=\"Simulado\" height=\"auto\"><br>
	<font size=\"-2\" style=\"font-family: 'Nunito', sans-serif; color:#666666; text-decoration: none;\"><b><font size=\"-2\">Simulado</font></b></font></a>
	</div>
	
<div style=\"float:left; margin-right:30px;\"><a style=\"text-decoration: none;\" target=\"frame_central_ead\" href=\"../acesso/frames_ead/frame_avaliacao.php?turma_disc=$turma_disc&tipo_ativ=7&cod_ativ=00&anograde=$anograde&cod_disc=$cod_disc\"><img src=\"../acesso/frames_ead/icones/icone_avaliacao.png\" title=\"Avaliação Online\" alt=\"Avaliação Online\" height=\"auto\"><br>
...
<hr>
<iframe width="100%" style="z-index:100;" height="" name="frame_central_ead" frameborder="0" id="frame_central_ead" scrolling="no" src="../acesso/frames_ead/frame_index.php?cod_disc=<?php echo ($cod_disc);?>&anograde=<?php echo ($anograde);?>&edicao=<?php echo $edicao?>&anograde=<?php echo ($anograde);?>&turma_disc=<?php echo $turma_disc?>"></iframe>
</div>
                          </div>
                      </section>
                  </div>
